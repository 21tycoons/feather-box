//
// Feather-Box: super thin jQuery lightbox package.
...
(function (factory) {
  ...
  function parseAttributes(object, prefix) {
    ...
    for (var key in object) {
      ...
      if (match) {
        ...
        attributes[dasherized] = object[key]
      }
    }
  ...
  FeatherBox.prototype = {
    ...
    defaults: {
      namespace:      'feather-box',        /* Name of the events and css class prefix */
      targetAttr:     'data-feather-box',   /* Attribute of the triggered element that contains the selector to the lightbox content */
